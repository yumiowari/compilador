...
SEQ_ID_MUL:
    ID ABRE_COLCHETES NUM FECHA_COLCHETES SEQ_ID_MUL_REC
    | ID ABRE_COLCHETES ID FECHA_COLCHETES SEQ_ID_MUL_REC
    ;

SEQ_ID_MUL_REC:
    VIRGULA ID ABRE_COLCHETES NUM FECHA_COLCHETES SEQ_ID_MUL_REC
...
CMD:
    ...
    | ESCREVA ID ABRE_COLCHETES NUM FECHA_COLCHETES ESCREVA_REC CMD
...
ESCREVA_REC:
    ...
    | VIRGULA ID ABRE_COLCHETES NUM FECHA_COLCHETES ESCREVA_REC
